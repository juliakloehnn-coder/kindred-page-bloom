  ...
  return (
    <section id="home" className="relative overflow-hidden bg-cream">
      <img
        ...
        width={1400}
        height={1400}
        className="pointer-events-none absolute right-0 top-0 z-0 h-full w-[70%] object-cover object-right"
      />
      <div
        aria-hidden="true"
        className="absolute inset-0 z-10 bg-gradient-to-r from-cream via-cream/90 via-45% to-cream/15"
      />
      <div
        aria-hidden="true"

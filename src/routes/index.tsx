  ...
  return (
    <section id="home" className="relative overflow-hidden bg-cream">
      ...
      <img
        ...
        width={1400}
        height={1400}
        className="pointer-events-none absolute right-0 bottom-0 z-10 h-[110%] w-auto max-w-[95%] object-contain object-bottom opacity-45 blur-[3px] grayscale contrast-50 saturate-0 brightness-125 mix-blend-multiply md:right-[10%] lg:right-[18%]"
      />
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="absolute inset-x-0 bottom-0 z-[15] h-1/3 bg-gradient-to-t from-cream via-cream/70 to-transparent"
      />
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-8 lg:gap-12">
          {socias.map((s) => (
            <div key={s.name} className="flex flex-col items-center text-center">
              ...
              <div className="mt-6">
                <h3 className="font-serif text-[1.5rem] leading-[1.2] text-navy sm:text-[1.75rem] lg:text-[2rem]">
                  <span>{s.line1}<br /></span>
                  <span className="font-bold">{s.line2}</span>
                </h3>
                <p className="mt-3 text-sm font-medium tracking-widest text-gold">{s.oab}</p>
...
function WhatsApp() {
  return (
    <a
      href="https://api.whatsapp.com/send?phone=5547999643469"
      target="_top"
      aria-label="WhatsApp"
